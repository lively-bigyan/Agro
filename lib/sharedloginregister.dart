...
class _LoginState extends State<Login> {
  ...
  login() async {
    final response = await http
        .post("http://192.168.0.109/agro/appApi/api_verification.php", body: {
      "flag": 1.toString(),
      "email": email,
      "password": password,
    });
...
class _RegisterState extends State<Register> {
  ...
  save() async {
    final response = await http
        .post("http://192.168.0.109/projectdb/api_verification.php", body: {
      "flag": 2.toString(),
      "name": name,
      "email": email,
      "mobile": mobile,
